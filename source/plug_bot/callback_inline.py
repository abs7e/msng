...
• قبول ، رفض
• كتم ، الغاء كتم 
• سبام + الكلمه + الرقم (سبام ارتكس 22)
• ايدي + ايدي بالرد"""
txx2 = """
• حظر ، الغاء حظر
• مسح المحظورين
...
• تفعيل تعطيل الساعه 
• تغيير اسمي + الاسم (تغيير اسمي Maro)
• سورس
"""
...
async def back(client, callback_query):
  await callback_query.edit_message_text("• اهلا بك في اوامر اليوزر البوت\n• ① اوامر الخاص\n• ② اوامر القنوات والمجموعات \n• ③ اوامر اليوتيوب \n• ④ اوامر الاذاعه\n• ⑤ اوامر التسليه \n• ⑥ اوامر اضافيه",reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("✅ - قناه السورس - ✅",url="https://t.me/AR_T_EX"),
             ],
             [
             InlineKeyboardButton("🔺️ - لتنصيب حسابك - 🔻",url="https://t.me/UX_2C"),
             ]]
             ))
